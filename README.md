...
<details>
  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        <li><a href="#для-администратора-или-владельца-курса">для-администратора-или-владельца-курса</a></li>
        ...
        <li><a href="#для-пользователя-не-записанного-на-курс">для-пользователя-не-записанного-на-курс</a></li>
      </ul>
    </li>
...
<!-- О ПРОЕКТЕ -->
## О-ПРОЕКТЕ
Проект предоставляет собой аналог обучающих платформ, но в формате чат-бота в telegram.
Любой человек может зайти в телеграм, написать боту и начать проходить любые курсы, имеющиеся в системе.
Также имеется система групп, старост и преподавателей/учителей, что допускает использование бота в учебных заведениях для дополнения дистанционного формата обучения. 

Бот содержит систему команд. Для их удобной манипуляции имеется удобное меню, отдельное для каждого типа пользователей. Все обращение к боту происходят асинхронно, что предотвращает зависание системы.
Отказоустойчивость обеспечивается отменой команды, которая привела к ошибке. И выводится сообщение об ошибке.
...
### для-администратора-или-владельца-курса
...
### для-пользователя-не-записанного-на-курс
